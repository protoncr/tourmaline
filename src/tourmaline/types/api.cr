# This file is auto-generated by the scripts/generate.py script
...
module Tourmaline
  ...
  class WebhookInfo
    ...
    property max_connections : Int64 | ::Nil
    ...
    def initialize(
      ...
      @last_error_date : Int64 | ::Nil = nil, 
      @last_error_message : String | ::Nil = nil, 
      @last_synchronization_error_date : Int64 | ::Nil = nil, 
      @max_connections : Int64 | ::Nil = nil, 
  ...
  class Chat
    ...
    property slow_mode_delay : Int64 | ::Nil
    ...
    def initialize(
      ...
      @active_usernames : Array(String) | ::Nil = nil, 
      ...
      @slow_mode_delay : Int64 | ::Nil = nil, 
      @message_auto_delete_time : Int64 | ::Nil = nil, 
  ...
  class Message
    ...
    property message_thread_id : Int64 | ::Nil
    ...
    property forward_from_message_id : Int64 | ::Nil
    ...
    def initialize(
      ...
      @message_thread_id : Int64 | ::Nil = nil, 
      ...
      @photo : Array(Tourmaline::PhotoSize) | ::Nil = nil, 
      ...
      @new_chat_members : Array(Tourmaline::User) | ::Nil = nil, 
      @left_chat_member : Tourmaline::User | ::Nil = nil, 
      @new_chat_title : String | ::Nil = nil, 
      @new_chat_photo : Array(Tourmaline::PhotoSize) | ::Nil = nil, 
      ...
      @migrate_to_chat_id : Int64 | ::Nil = nil, 
      @migrate_from_chat_id : Int64 | ::Nil = nil, 
      @pinned_message : Tourmaline::Message | ::Nil = nil, 
  ...
  class Poll
    ...
    property correct_option_id : Int64 | ::Nil
    ...
    property open_period : Int64 | ::Nil
  ...
  class Location
    ...
    property live_period : Int64 | ::Nil
    
    # Optional. The direction in which user is moving, in degrees; 1-360. For active live locations only.
    property heading : Int64 | ::Nil
    
    # Optional. The maximum distance for proximity alerts about approaching another chat member, in meters. For sent live locations only.
    property proximity_alert_radius : Int64 | ::Nil
    
    def initialize(
      @longitude : Float64, 
      @latitude : Float64, 
      @horizontal_accuracy : Float64 | ::Nil = nil, 
      @live_period : Int64 | ::Nil = nil, 
      @heading : Int64 | ::Nil = nil, 
      @proximity_alert_radius : Int64 | ::Nil = nil
    )
    end
  end
  ...
  class ReplyKeyboardMarkup
    ...
    def initialize(
      @keyboard : Array(Array(Tourmaline::KeyboardButton)), 
  ...
  class ChatInviteLink
    ...
    property member_limit : Int64 | ::Nil
    
    # Optional. Number of pending join requests created using this link
    property pending_join_request_count : Int64 | ::Nil
    ...
    def initialize(
      ...
      @is_revoked : Bool, 
      @name : String | ::Nil = nil, 
      @expire_date : Int64 | ::Nil = nil, 
      @member_limit : Int64 | ::Nil = nil, 
      @pending_join_request_count : Int64 | ::Nil = nil
    )
    end
  end
  ...
  class ResponseParameters
    ...
    property retry_after : Int64 | ::Nil
    
    def initialize(
      @migrate_to_chat_id : Int64 | ::Nil = nil, 
      @retry_after : Int64 | ::Nil = nil
    )
    end
  end
  ...
  class InputMediaVideo
    ...
    property width : Int64 | ::Nil
    
    # Optional. Video height
    property height : Int64 | ::Nil
  ...
  class InlineQueryResultArticle
    ...
    property thumbnail_width : Int64 | ::Nil
    
    # Optional. Thumbnail height
    property thumbnail_height : Int64 | ::Nil
    ...
    def initialize(
      ...
      @thumbnail_width : Int64 | ::Nil = nil, 
      @thumbnail_height : Int64 | ::Nil = nil
    )
    end
  end
  ...
  class InlineQueryResultPhoto
    ...
    property photo_width : Int64 | ::Nil
    
    # Optional. Height of the photo
    property photo_height : Int64 | ::Nil
    ...
    def initialize(
      ...
      @photo_width : Int64 | ::Nil = nil, 
      @photo_height : Int64 | ::Nil = nil, 
      @title : String | ::Nil = nil, 
      @description : String | ::Nil = nil, 
      @caption : String | ::Nil = nil, 
      @parse_mode : String | ::Nil = nil, 
  ...
  class InlineQueryResultGif
    ...
    property gif_width : Int64 | ::Nil
    
    # Optional. Height of the GIF
    property gif_height : Int64 | ::Nil
    
    # Optional. Duration of the GIF in seconds
    property gif_duration : Int64 | ::Nil
    ...
    def initialize(
      ...
      @gif_url : String, 
      @thumbnail_url : String, 
      @gif_width : Int64 | ::Nil = nil, 
      @gif_height : Int64 | ::Nil = nil, 
      @gif_duration : Int64 | ::Nil = nil, 
  ...
  class InlineQueryResultMpeg4Gif
    ...
    # Optional. Video width
    property mpeg4_width : Int64 | ::Nil
    
    # Optional. Video height
    property mpeg4_height : Int64 | ::Nil
    
    # Optional. Video duration in seconds
    property mpeg4_duration : Int64 | ::Nil
    ...
    def initialize(
      ...
      @mpeg4_url : String, 
      @thumbnail_url : String, 
      @mpeg4_width : Int64 | ::Nil = nil, 
      @mpeg4_height : Int64 | ::Nil = nil, 
      @mpeg4_duration : Int64 | ::Nil = nil, 
      @thumbnail_mime_type : String | ::Nil = nil, 
      @title : String | ::Nil = nil, 
      @caption : String | ::Nil = nil, 
      @parse_mode : String | ::Nil = nil, 
  ...
  class InlineQueryResultVideo
    ...
    # Optional. Video width
    property video_width : Int64 | ::Nil
    
    # Optional. Video height
    property video_height : Int64 | ::Nil
    
    # Optional. Video duration in seconds
    property video_duration : Int64 | ::Nil
    ...
    def initialize(
      ...
      @parse_mode : String | ::Nil = nil, 
      @caption_entities : Array(Tourmaline::MessageEntity) | ::Nil = nil, 
      @video_width : Int64 | ::Nil = nil, 
      @video_height : Int64 | ::Nil = nil, 
      @video_duration : Int64 | ::Nil = nil, 
      @description : String | ::Nil = nil, 
      @reply_markup : Tourmaline::InlineKeyboardMarkup | ::Nil = nil, 
      @input_message_content : Tourmaline::InputMessageContent | ::Nil = nil
    )
  ...
  class InlineQueryResultAudio
    ...
    property audio_duration : Int64 | ::Nil
  ...
  class InlineQueryResultVoice
    ...
    property voice_duration : Int64 | ::Nil
  ...
  class InputInvoiceMessageContent
    ...
    property max_tip_amount : Int64 | ::Nil
    
    # Optional. A JSON-serialized array of suggested amounts of tip in the smallest units of the currency (integer, not float/double). At most 4 suggested tip amounts can be specified. The suggested tip amounts must be positive, passed in a strictly increased order and must not exceed max_tip_amount.
    property suggested_tip_amounts : Array(Int64) = [] of Int64
  ...
  class EncryptedPassportElement
    ...
    def initialize(
      ...
      @phone_number : String | ::Nil = nil, 
      @email : String | ::Nil = nil, 
      @files : Array(Tourmaline::PassportFile) | ::Nil = nil, 
      ...
      @translation : Array(Tourmaline::PassportFile) | ::Nil = nil
    )
    end
  end
