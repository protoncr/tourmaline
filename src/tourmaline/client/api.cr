...
module Tourmaline
  class Client
    module Api
      ...
      def get_updates(
        offset : Int64 | ::Nil = nil,
        limit : Int64 | ::Nil = nil,
        timeout : Int64 | ::Nil = nil,
      ...
      def send_message(
        ...
        reply_to_message_id : Int64 | ::Nil = nil,
      ...
      def get_chat_member_count(
        ...
        request(Int64, "getChatMemberCount", {
          chat_id: chat_id,
        })
      end
