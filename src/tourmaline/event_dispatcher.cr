    ...
    macro finished
      {% verbatim do %}
        {%
          ...
          TAG_HASH[Tourmaline::Listeners::TAG].each do |service_id|
        ...
        private def get_event_dispatcher
          ...
          {% for service_id in TAG_HASH[Tourmaline::Listeners::TAG] %}
...
ADI.auto_configure AED::EventListenerInterface, {tags: [Tourmaline::Listeners::TAG]}
